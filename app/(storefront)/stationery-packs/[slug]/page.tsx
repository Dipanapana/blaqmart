...
export async function generateMetadata({ params }: PackPageProps) {
  const data = await getPackData(params.slug)
  if (!data) return { title: "Pack Not Found" }

  return {
    title: `${data.pack.name} | Blaqmart`,
    description: data.pack.description || `Complete stationery pack with ${data.pack.items.length} items. Quality school supplies delivered to your door.`,
  }
}
      ...
      <main>
        <div className="container px-4 py-6">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <div className="rounded-xl bg-gray-50 p-4 text-center">
              <span className="text-2xl">📦</span>
              <p className="mt-2 text-sm font-medium">Complete Pack</p>
